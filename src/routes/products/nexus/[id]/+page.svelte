<script>
    ...
    async function handleAssignClient() {
        ...
        try {
            ...
            const clientName = MOCK_CLIENTS.find(
        ...
        {:else if device}
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2 space-y-6">
                    <Card class="p-6">
                        ...
                        <div>
                            ...
                            <p
                                class="text-slate-700 bg-slate-50 p-3 rounded-md text-sm"
                            >
                                {device.notes}
                            </p>
                        </div>
                ...
                <div class="space-y-6">
                    <Card class="p-6">
                        <h3
                            class="text-sm font-medium text-slate-900 uppercase tracking-wider mb-4"
                        >
                            Cliente Asignado
                        </h3>
                        {#if device.client}
                            <div
                                class="bg-blue-50 p-4 rounded-md mb-4 border border-blue-100"
                            >
        ...
        >
            ...
            >
                ...
                <p class="text-sm text-slate-500 mb-6">
                    Selecciona un cliente para asignar el dispositivo <strong
                        >{device.device_id}</strong
                    >.
                </p>
